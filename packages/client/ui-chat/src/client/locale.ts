...
export const zh = {
  ...
  'message.edit.save': '保存为新版本',
  'message.edit.saving': '保存中…',
  'message.edit.cancel': '取消',
  'message.version.label': '消息版本',
  'message.version.previous': '上一个版本',
  'message.version.next': '下一个版本',
  'message.delete': '删除此轮及后续内容',
...
export const en = {
  ...
  'message.edit.save': 'Save as new version',
  'message.edit.saving': 'Saving…',
  'message.edit.cancel': 'Cancel',
  'message.version.label': 'Message versions',
  'message.version.previous': 'Previous version',
  'message.version.next': 'Next version',
  'message.delete': 'Delete this turn and everything after it',
