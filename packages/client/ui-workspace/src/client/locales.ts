...
export const zh = {
  ...
  'archive.show': '查看已归档会话',
  'archive.back': '返回会话',
  'archive.empty': '暂无已归档会话',
  'archive.selectAll': '全选已归档会话',
  'archive.selectOne': '选择会话“{name}”',
  'archive.selected': '已选择 {n} 项',
  'archive.restore': '恢复会话',
  'archive.delete': '永久删除',
  'archive.deleteSelected': '删除所选',
  'archive.deleteTitle': '永久删除会话',
  'archive.deleteOneDesc': '将永久删除“{name}”及其全部对话记录。此操作无法撤销。',
  'archive.deleteManyDesc': '将永久删除所选 {n} 个会话及其全部对话记录。此操作无法撤销。',
  'archive.deleting': '正在删除会话…',
  'archive.deleteFailed': '{n} 个会话删除失败，请重试。',
  'archive.selectActiveAll': '全选会话',
  'archive.archiveSelected': '存档所选',
  'archive.archiving': '正在存档会话…',
  'archive.archiveFailed': '{n} 个会话归档失败，请重试。',
  'selection.enter': '编辑会话',
  'selection.exit': '完成',
  'selection.title': '选择会话',
...
export const en = {
  ...
  'archive.show': 'View archived sessions',
  'archive.back': 'Back to sessions',
  'archive.empty': 'No archived sessions',
  'archive.selectAll': 'Select all archived sessions',
  'archive.selectOne': 'Select session “{name}”',
  'archive.selected': '{n} selected',
  'archive.restore': 'Restore session',
  'archive.delete': 'Delete permanently',
  'archive.deleteSelected': 'Delete selected',
  'archive.deleteTitle': 'Delete sessions permanently',
  'archive.deleteOneDesc': 'This permanently deletes “{name}” and its entire conversation history. This cannot be undone.',
  'archive.deleteManyDesc': 'This permanently deletes the selected {n} sessions and all their conversation history. This cannot be undone.',
  'archive.deleting': 'Deleting sessions…',
  'archive.deleteFailed': '{n} sessions could not be deleted. Try again.',
  'archive.selectActiveAll': 'Select all sessions',
  'archive.archiveSelected': 'Archive selected',
  'archive.archiving': 'Archiving sessions…',
  'archive.archiveFailed': '{n} sessions could not be archived. Try again.',
  'selection.enter': 'Edit sessions',
  'selection.exit': 'Done',
  'selection.title': 'Select sessions',
